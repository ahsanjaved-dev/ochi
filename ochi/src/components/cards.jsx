...
function Cards() {
  return (
    <div className='w-full grid gap-y-5 md:h-screen md:flex md:items-center md:gap-4 px-5 md:px-14'>
        <div className='cardContainer md:w-1/2 h-[40vh] md:h-[65vh] '>
        ...
        <div className='cardContainer grid gap-y-5 md:w-1/2 md:h-[65vh] md:flex md:gap-4 '>
            <div className='md:w-1/2 h-[40vh] md:h-full bg-[#212121] rounded-lg flex items-center justify-center relative' >
            ...
            <div className='md:w-1/2 h-[40vh] md:h-full bg-[#212121] rounded-lg flex items-center justify-center relative' >
                <img className='w-[28vw] md:w-[8vw]' src="https://ochi.design/wp-content/uploads/2022/04/logo003.png" alt="" />
