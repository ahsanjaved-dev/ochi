    ...
    <div data-scroll data-scroll-section data-scroll-speed="-.5" className='w-full h-screen pt-1'>
        <div className='flex'>
            <div className='w-[90%] md:w-[80%]'>
                <div className='textStructure px-5 mt-10 md:px-12 md:mt-24'>
                    <div className='masker'>
                        <div className='w-fit flex items-end overflow-hidden'>
                            <h1 className='font-["Founders_Grotesk_Regular"] font-extrabold text-[10.5vw] leading-[.8] tracking-tighter pt-[2vw] md:text-[7.5vw] md:leading-[.65] md:pt-[2vw]'><b> WE CREATE</b></h1>
                        </div>
                        <div className='w-fit flex items-end overflow-hidden'>
                            <motion.div initial={{width:"0"}} animate={{width:"12vw"}} transition={{ease:[0.5, 0, 0.75, 0],duration:1}} className='w-[12vw] h-[5.5vh] md:h-[5.8vw] bg-[#004D43] relative -top-[0.5vw] md:-top-[1vw] rounded-md flex items-center justify-center text-[#F1F1F1]'>
                            ...
                            <h1 className='font-["Founders_Grotesk_Regular"] font-extrabold text-[10.5vw] leading-[.8] pt-[4vw] ms-[1vw] tracking-tighter md:text-[7.5vw] md:leading-[.65]  relative md:pt-[2vw]'><b>EYE-OPENING</b></h1>
                        </div>
                        <div className='w-fit flex items-end overflow-hidden'>
                            <h1 className='font-["Founders_Grotesk_Regular"] font-extrabold text-[10.5vw] leading-[.8]  pt-[2vw] tracking-tighter  md:text-[7.5vw] md:leading-[.65] md:pt-[2vw] md:-mb-[1vw]'><b>PRESENTATIONS</b></h1>
                        </div>
                    </div>
                </div>
            </div>

            <div className=' flex justify-end items-center w-[10%] md:w-[20%]'>
                <div className='w-[6vw] h-[12vh] md:w-[54px] md:h-[172px] bg-[#E73C37]'>
                    <svg className='hidden md:block md:h-[171.358px] md:w-[53.08px]'>
        ...
        <div className='border-t-[1px] border-zinc-800 md:border-zinc-300 w-full grid p-5 mt-96 md:flex md:justify-between md:items-center  md:mt-24 md:pt-3 md:px-12'>
                <div className='grid gap-7 md:flex md:w-[65%] md:justify-between'>
                    <p className='tracking-tight leading-none font-["Neue_Montreal"]'>For public and private companies</p>
                    <p className='tracking-tight leading-none font-["Neue_Montreal"]'>From the first pitch to IPO</p>
                </div>
                <div className='start md:flex md:justify-end md:gap-2 md:items-center md:w-[20%] md:pt-1 '>
                    <div className='mt-10 md:mt-0 border-[1.5px] w-[160px]    border-black px-2 py-1 rounded-full font-["Neue_Montreal"] text-sm '>START THE PROJECT</div>
                    <div className='md:w-7 md:h-7 md:flex md:items-center md:justify-center md:border-[1.4px] md:border-black md:rounded-full'> <span className='md:rotate-[45deg] md:flex hidden'> <FaArrowUp></FaArrowUp> </span> </div>
                </div>
        </div>
    </div>
  )
