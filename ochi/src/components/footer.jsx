...
function Footer() {
    return (
     <div className='w-full p-5 mt-8 md:h-screen md:p-10 md:flex md:gap-5'>

        <div className='w-1/2 h-full flex flex-col justify-between'>
            <div className='headings'>
                <h1 className='text-[12.5vw] leading-[12vw] md:text-[6.5vw] font-["Founders_Grotesk_Regular"] md:leading-[6vw] font-extrabold tracking-tighter'>EYE-</h1>
                <h1 className='text-[12.5vw]  leading-[12vw] md:text-[6.5vw] font-["Founders_Grotesk_Regular"] md:leading-[6vw] font-extrabold tracking-tighter '>OPENING</h1>
            </div>
        ...
        <div className='md:w-1/2 md:flex md:flex-col justify-between'>
            <div className='w-full h-full'>
                <h1 className='text-[12.5vw]  leading-[12vw]  md:text-[6.5vw] md:leading-[6vw] font-["Founders_Grotesk_Regular"] font-extrabold tracking-tighter'>PRESENTATIONS</h1>
                <div className='flex justify-between '>
                    <div>
                        <p className='mt-2'>S:</p><br />
                        <a>Instagram</a><br />
                        <a>Behance</a><br />
                        <a>Facebook</a><br />
                        <a>Linkedin</a>

                        <p className='mt-16'>E:</p><br />
                        <a>hello&copy;ochi.design</a>
                    </div>
                    <div className='pt-24 pe-6'>
                        <p>M:</p><br />
                            <a>Home</a><br />
                            <a>Services</a><br />
                            <a>Our Work</a><br />
            ...
            <div className='md:flex md:justify-between text-zinc-300 '>
                    <div>
                        <p className='mt-6'>&copy;ochi design 2024. Legal Terms</p>
                    </div>
                    <div>
                        <p className='mt-4 pe-6 md:mt-6'>Website by Obys</p>
                    </div>
            </div>
